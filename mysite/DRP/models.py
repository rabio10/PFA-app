...
class Entrepot_central(models.Model):
    ...
    entrp_planning = models.FileField(upload_to='planning_total/',null=True, blank=True)
...
class Depot(models.Model):
    ...
    adresse_depot = models.CharField(max_length=100, null=False, blank=False)
    ...
    planning_depot = models.FileField(upload_to='planning_depot/',null=True, blank=True)
